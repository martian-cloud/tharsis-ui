/**
 * @generated SignedSource<<ef9cbb4c7bf9a26d4bd8bcbc4ae217a6>>
...
export type WorkspaceSearchFragment_workspaces$data = {
  readonly workspaces: {
  ...
  readonly " $fragmentType": "WorkspaceSearchFragment_workspaces";
};
export type WorkspaceSearchFragment_workspaces$key = {
  ...
  "selections": [
    {
      ...
      "kind": "LinkedField",
      "name": "__WorkspaceSearch_workspaces_connection",
      "plural": false,
      "selections": [
        {
          "alias": null,
