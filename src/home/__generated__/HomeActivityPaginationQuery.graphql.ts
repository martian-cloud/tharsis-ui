/**
 * @generated SignedSource<<14dc82bfda60406b818d7fdeb8da9758>>
...
export type HomeActivityPaginationQuery$variables = {
  after?: string | null;
  before?: string | null;
  first?: number | null;
  last?: number | null;
};
export type HomeActivityPaginationQuery$data = {
  readonly " $fragmentSpreads": FragmentRefs<"HomeActivityFragment_activity">;
};
export type HomeActivityPaginationQuery = {
  response: HomeActivityPaginationQuery$data;
  variables: HomeActivityPaginationQuery$variables;
};
...
return {
  "fragment": {
    ...
    "kind": "Fragment",
    "metadata": null,
    "name": "HomeActivityPaginationQuery",
    "selections": [
      {
        "args": null,
        "kind": "FragmentSpread",
