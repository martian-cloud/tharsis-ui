/**
 * @generated SignedSource<<3de26fd9d7d9c6763be0ab18e6233e34>>
...
export type NamespaceActivityPaginationQuery$variables = {
  after?: string | null;
  before?: string | null;
  first?: number | null;
  last?: number | null;
...
export type NamespaceActivityPaginationQuery$data = {
  readonly " $fragmentSpreads": FragmentRefs<"NamespaceActivityConnectionFragment_activity">;
};
export type NamespaceActivityPaginationQuery = {
  response: NamespaceActivityPaginationQuery$data;
  variables: NamespaceActivityPaginationQuery$variables;
};
...
return {
  ...
  "params": {
    "cacheID": "c03e8c19e07abc853fcd863087d4730e",
    "id": null,
    "metadata": {},
    "name": "NamespaceActivityPaginationQuery",
    "operationKind": "query",
