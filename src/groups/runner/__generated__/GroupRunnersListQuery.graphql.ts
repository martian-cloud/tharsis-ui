...
export type GroupRunnersListQuery$variables = {
  after?: string | null;
  first: number;
  id: string;
};
...
export type GroupRunnersListQuery = {
  response: GroupRunnersListQuery$data;
  variables: GroupRunnersListQuery$variables;
};
