...
interface Props {
    workspaceKey: ManagedIdentityWorkspaceListItemFragment_workspace$key
    last?: boolean
}

function ManagedIdentityWorkspaceListItem(props: Props) {
    const { last } = props;
    const theme = useTheme();

    const data = useFragment<ManagedIdentityWorkspaceListItemFragment_workspace$key>(graphql`
...
export default ManagedIdentityWorkspaceListItem
